...
author: "Mohammed Faizan, Prachi Jaiswal, Karan Garg"
date: "`r Sys.Date()`"
output:
...
#### How are the wind speeds different or similar in different parts of the city?


#### What is the effect of temperature on wind speed?
...
*  Lot of missing data
*  Confirmation to the previous plot of following Least recorded areas with similar kind of pattern
   *  Flinders Street
...
*  After the Wednesday afternoon of 2nd week of june in Siddeley Street, a sudden spike in wind speed is observed.

]
.panel[.panel-name[R]
```{r ref.label="linelga", echo=TRUE, eval=FALSE}
```
]
]
