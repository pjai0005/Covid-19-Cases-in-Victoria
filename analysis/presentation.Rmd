...
output:
  xaringan::moon_reader:
    css: [default, style.css,"MonashBS.css"]
    lib_dir: libs
    nature:
...
# bases <- save_history(graphlga0, grand_tour(2), max = 3)
...
pg <- ggplotly(graphlga,
                width=800, height=500) %>%
                 ...
                 easing = "linear")
pg
htmltools::save_html(pg, file="graphlga0.html")
